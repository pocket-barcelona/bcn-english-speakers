...
snippet: "Catalan is the official language of Catalonia (_Catalunya_ in Catalan) so it's no surprise that you will at some point hear it in Barcelona."
...
From personal experience, it can actually be quite tricky to find learning resources and courses in which to practice and learn the language -- not to mention people with whom to speak and practice the language.
