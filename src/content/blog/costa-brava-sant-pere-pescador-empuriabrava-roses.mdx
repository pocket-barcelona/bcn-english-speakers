...
If you're looking for some hiking in the area, you might want to consider a day trip to [Montjoi](https://maps.app.goo.gl/SfK5ETHdSSWV3HcL7) from [Platja de Canyelles Grosses](https://maps.app.goo.gl/ASJGGnWRcLehtTAfA) (taking any parking spot you can find, even if it's high up on the main road away from the Canyelles Grosses beach). If you can find it, there's an entry point to the [Camí de Ronda here](https://maps.app.goo.gl/386w3Z72A3maM1ut5).
